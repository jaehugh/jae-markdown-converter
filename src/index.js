...
export function routeRequest(request) {
  ...
  if (url.pathname === "/api/capabilities") {
    return jsonResponse({
      ...
      inputs: ["docx", "html", "json", "csv", "xml", "txt"],
      outputs: ["markdown"],
...
<body><div class="shell">
  ...
  <main>
    ...
    <section class="work">
      <div class="input"><label class="drop" id="drop"><input id="file" type="file" accept=".docx,.html,.htm,.json,.csv,.xml,.txt,text/*"><div><b>Drop a document here</b><span>or choose a local file</span></div></label><div class="types"><span>DOCX</span><span>HTML</span><span>JSON</span><span>CSV</span><span>XML</span><span>TXT</span></div><p class="status" id="status">Ready. Maximum file size: 10 MB.</p></div>
    ...
    <section class="details"><article><h2>Private by default</h2><p>Conversion runs locally. No document content is sent to the Worker.</p></article><article><h2>AI-ready structure</h2><p>Headings, lists, tables, and links stay readable for models and humans.</p></article><article><h2>Need PDF?</h2><p>Use the dedicated <a href="https://documents.johnhughesai.com">Document Parser</a> for local PDF extraction.</p></article></section>
  </main>
